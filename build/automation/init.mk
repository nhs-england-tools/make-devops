...
devops-copy: ### Copy the DevOps automation toolchain scripts from this codebase to given destination - mandatory: DIR
	function sync() {
		...
		[ ! -f "$(DIR)/documentation/diagrams/C4 model.drawio" ] && cp -fv "build/automation/lib/project/template/documentation/diagrams/C4 model.drawio" $(DIR)/documentation/diagrams
...
devops-update devops-synchronise: ### Update/upgrade the DevOps automation toolchain scripts used by this project - optional: LATEST=true, NO_COMMIT=true
	...
	function sync() {
		...
		[ ! -f "$(PARENT_PROJECT_DIR)/documentation/diagrams/C4 model.drawio" ] && cp -fv "build/automation/lib/project/template/documentation/diagrams/C4 model.drawio" $(PARENT_PROJECT_DIR)/documentation/diagrams
